...
- When annotation-derived `.rmsx.in` targets are unavailable, `rmsx_runner.py` attempts fallback extraction from `rsmviewer/RNAMotifScanX/PDB_prebuild.tgz` (if present) before aborting.
