...
def initialize_registry(
    ...
    Args:
        ...
        include_bundled: Explicitly enable legacy bundled Atlas/Rfam providers.
            The end-user distribution keeps this disabled so current online
    ...
    # Bundled providers remain importable for development migration tests, but
    # are not registered in the relocatable end-user distribution.
    if include_bundled:
