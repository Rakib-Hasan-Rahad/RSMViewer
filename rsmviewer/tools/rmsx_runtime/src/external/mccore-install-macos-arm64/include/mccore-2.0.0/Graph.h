...
namespace mccore
{
  ...
  public:
	...
	return (head < right.head
       ...
       * vertex container.
       */
      V& getHeadVertex (Graph& g) throw (NoSuchElementException)
      {
  if (g.vertices.size () <= head)
	  {
	    throw NoSuchElementException ();
	  }
  return g.vertices[head];
      }
       ...
       * vertex container.
       */
      const V& getHeadVertex (const Graph& g) const throw (NoSuchElementException)
      {
  if (g.vertices.size () <= head)
	  {
	    throw NoSuchElementException ();
  ...
  return g.vertices[head];
       ...
       * vertex container.
       */
      V& getTailVertex (Graph& g) throw (NoSuchElementException)
      {
  if (g.vertices.size () <= tail)
	  {
	    throw NoSuchElementException ();
	  }
  return g.vertices[tail];
      }
       ...
       * vertex container.
       */
      const V& getTailVertex (const Graph& g) const throw (NoSuchElementException)
      {
  if (g.vertices.size () <= tail)
	  {
	    throw NoSuchElementException ();
